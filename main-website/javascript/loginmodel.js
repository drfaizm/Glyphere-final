 ...
 * Then add to homepage.html  (before </body>):
 *
...
\
    ...
    /* ─────────────────────────────────────────
       ...
       Targets both desktop and mobile nav links.
    ───────────────────────────────────────── */
    function interceptNavButtons() {
        ...
        selectors.forEach(function (sel) {
            ...
            els.forEach(function (el) {
                /* Remove the href so it doesn't navigate */
                el.removeAttribute('href');
                el.style.cursor = 'pointer';

                var mode = (sel.indexOf('signup') !== -1 || sel.indexOf('sign-up') !== -1)
                    ? 'register'
                    : 'login';
